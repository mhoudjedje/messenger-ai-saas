    ...
    <div className={`min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 flex items-center justify-center p-4 ${isRTL ? 'rtl' : 'ltr'}`}>
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600">ابدأ مع أتيم اليوم</p>
        </div>
        ...
        <Card className="p-8 shadow-lg">
          {success ? (
            <div className="text-center py-8">
              ...
              <h3 className="text-lg font-semibold text-gray-900 mb-2">تم إنشاء الحساب بنجاح</h3>
              <p className="text-gray-600 text-sm">تحقق من بريدك الإلكتروني للتحقق من حسابك</p>
            </div>
          ) : (
            <>
              {/* Signup Form */}
